<template>
  <div class="align-items-start">
    <div class="d-flex">
      <Sidebar @TestEmit="NyobaEmit" @TestEmits="NyobaFlex" style="height: 100"></Sidebar>
      <div class="" 
      :class="{ 'home-sektes': isActive, 'home-sekteb': !isActive }"
      >
        <Topbar></Topbar>
        <HomeComp v-show="success"></HomeComp>
        <center>

          <ViewDataVue v-show="success2"></ViewDataVue>
        </center>
        <AddCompVue v-show="success1"></AddCompVue>
...
import Sidebar from "../components/sidbarTest.vue";
import Footer from "@/components/FooterComp.vue";
import AddCompVue from "@/components/AddComp.vue";
import HomeComp from "@/components/HomeComp.vue";
import ViewDataVue from "@/components/ViewData.vue";
...
export default {
  ...
  created() {
    let data = this.$session.get("page")
    if (data == 1) {
      this.success = true
    } else if (data == 2) {
      this.success1 = true
